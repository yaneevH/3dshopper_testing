...
new GLTFLoader().load('./airburner_5p_referencehuman.glb', function (gltf) {
    ...
    function onClick(event) {
        if (document.getElementById('info-box')) return; // Prevent further clicks if info box is displayed
    ...
    function showInfoBox(object, event) {
        ...
        infoBox.innerHTML = `<div>CLICKED <button id="close-info-box" style="margin-left: 20px;">X</button></div>`;

        document.body.appendChild(infoBox);

        // Disable further click detection
